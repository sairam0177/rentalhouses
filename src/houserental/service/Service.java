...
public class Service {
	...
	public AddHouseRental userDetailsService(AddHouseRental rental) {
		EntityManagerFactory entityManagerFactor = Persistence.createEntityManagerFactory("houserental");
		EntityManager entityManager = entityManagerFactor.createEntityManager();
		try {
			TypedQuery<AddHouseRental> query = entityManager.createQuery("from AddHouseRental where userId=:userId",
					AddHouseRental.class);
